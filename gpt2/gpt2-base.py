...
dotenv.load_dotenv()
MODEL_NAME = "openai-community/gpt2"  # uncased by default
TOKENIZER_NAME = "openai-community/gpt2"
TRAIN_DATASET_NAME = "train-v1.1.json"
VAL_DATASET_NAME = "dev-v1.1.json"
OUTPUT_MODEL_NAME = "best_gpt2_model"
OUTPUT_TOKENIZER_NAME = "best_gpt2_tokenizer"
...
if __name__ == "__main__":
    ...
    model: PreTrainedModel = GPT2ForQuestionAnswering.from_pretrained(model_name)
